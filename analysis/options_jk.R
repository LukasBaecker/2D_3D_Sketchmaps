...
# function to view kable html tables in the panel (can drag and drop to Word) ####
...
#   filter(op == "=~") %>% 
#   select('Latent Factor'=lhs, Indicator=rhs, B=est, SE=se, 'p-value'=pvalue) %>% 
#   view_kable(digits = 3, format="html", caption="Factor Loadings")
####
